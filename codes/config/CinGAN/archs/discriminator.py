...
class PatchGANDiscriminator(nn.Module):
    ...
    def __init__(self, in_c, nf, nb, stride=2, norm_layer=nn.BatchNorm2d):
        ...
        kw = 4
        padw = 1
        sequence = [nn.Conv2d(in_c, nf, kernel_size=kw, stride=stride, padding=padw), nn.LeakyReLU(0.2, True)]
        nf_mult = 1
        nf_mult_prev = 1
